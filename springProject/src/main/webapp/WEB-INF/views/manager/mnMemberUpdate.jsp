...
<div class="mnMember" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
	...
	<button type="button" style="width:100px" onclick="javascript:history.back()">목록으로</button>
	<button style="width:120px" onclick="profileToggle()" ${member.userType eq 'young' ? 'hidden' : 'type="button"' }>프로필 보기</button>
	</div>
</form>
	...
	<button id="profileButton" class="h3" type="submit" style="width:100px">수정완료</button>
	<br>
	<table id="mnProfileT" style="display: none;">
		...
		<tr align="center">
			<td rowspan="3">
				<input type="text" id="proPhoto" name="proPhoto" style="width:120px" value="${profile.originalFilename}">
			</td>
			<td>
