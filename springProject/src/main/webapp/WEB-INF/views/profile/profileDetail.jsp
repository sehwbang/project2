			...
			<table border="1" class="table2">
				<tr>
					...
					<td scope="col"><input type="text" id="height"
						name="proHeight" value="${profileMember.proHeight}" required>
						cm</td>
					<th scope="col">몸무게</th>
					<td scope="col"><input type="text" id="weight"
						name="proWeight" value="${profileMember.proWeight}" required>
						kg</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4" scope="col"><textarea class="textarea"
							name="personal" cols="35" rows="10">${profileMember.personal}</textarea>
					</td>
				</tr>
				<tr>
